        ...
        if cmd == "help":
            ...
            if author_id == bot_settings["admin_id"]:
                if args[0] == "on" and len(args) > 1:
                    ...
                    self.change_thread_title(bot_settings["locked_group_name"], thread_id)
            ...
            if author_id == bot_settings["admin_id"]:
                if args[0] == "on" and len(args) > 1:
                    ...
                    thread_info = self.fetch_thread_info(thread_id)[thread_id]
                    for user_id in thread_info.participants:
                        self.change_nickname(bot_settings["locked_nickname"], user_id, thread_id)
            ...
            if message_object.mentions:
                ...
                user_info = self.fetch_user_info(user_id)[user_id]
            ...
            if author_id == bot_settings["admin_id"]:
                if args[0] == "target" and args[1] == "on" and len(args) > 2 and message_object.mentions:
                    ...
                    self.loder_thread = threading.Thread(target=self.loder_target, args=(user_id, thread_id, thread_type, time))
            ...
            if author_id == bot_settings["admin_id"]:
                if args[0] == "on" and len(args) > 1:
                    ...
                    self.autoconvo_thread = threading.Thread(target=self.autoconvo, args=(thread_id, thread_type, time))
            ...
            if thread_type == ThreadType.GROUP:
                ...
                user1_info = self.fetch_user_info(user1)[user1]
                user2_info = self.fetch_user_info(user2)[user2]
